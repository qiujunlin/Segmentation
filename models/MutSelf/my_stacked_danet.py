...
class DAF_stack(nn.Module):
    ...
    def forward(self, x):
       ...
       # semVector_1_1,semanticModule_1_1 = self.semanticModule_1_1(torch.cat((down4, fuse1),1))   # encoder  decoder
       ...
       # attention1_3=self.conv8_2((attn_cam3+attn_pam3)*self.conv_sem_1_2(semanticModule_1_2))
        attention1_3=self.conv8_2((attn_cam3+attn_pam3))
        ...
        attention1_2=self.conv8_3((attn_cam2+attn_pam2))
        ...
        attention1_1 = self.conv8_4((attn_cam1+attn_pam1) )
        ...
        predict4_2 = self.predict4_2(attention1_4)
        predict3_2 = self.predict3_2(attention1_3)
        predict2_2 = self.predict2_2(attention1_2)
        predict1_2 = self.predict1_2(attention1_1)
