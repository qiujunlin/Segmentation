...
class MyNet(nn.Module):
    def __init__(self, channel=32):
       ...
       # self.decoder5 = DecoderBlock(in_channels=512, out_channels=512)
        ...
        self.edgeout =  nn.Conv2d(channel, 1, 1)
    ...
    def forward(self, x):
        ...
        # flusion
        outflu = self.com(x,upx1,upx2)
        att2 =self.edgeconv(outflu)

        att1 =d1_1
        out2 = self.noncal(att1,att2)


        edgeout = self.edgeout(outflu)
        ...
        edgeout = F.interpolate(edgeout, scale_factor=4, mode='bilinear')

        return pred1,pred2,edgeout
