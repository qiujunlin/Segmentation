...
class MyNet(nn.Module):
    def __init__(self, channel=32):
        ...
        self.out3 =  nn.Conv2d(channel, 1, 1)
        self.out4 =  nn.Conv2d(channel, 1, 1)
        self.refine = RefineUNet(1,1)

        self.ca = ChannelAttention(64)
        self.sa = SpatialAttention()
        self.outatte = nn.Conv2d(64, 32, 1)
    ...
    def forward(self, x):
        ...
        flusion1 = self.rf1(x4)  # 1 64 11 11
        flusion2 = self.rf2(torch.cat((self.upsample(x4),x3),dim=1)) # # 1 64 22 2
        ...
        out2 =self.out1(att_out2)
        out3 =self.out1(att_out3)
        ...
        redfine = self.refine(prediction2)
        ...
        return prediction1,prediction2,prediction3,redfine
...
if __name__ == '__main__':
    ...
    print(prediction1.size(), prediction2.size(),prediction3.size(),prediction4.size())
    # net =BCA(64,64,64)
