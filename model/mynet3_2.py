...
class MyNet(nn.Module):
    def __init__(self, channel=64):
        ...
        self.rf1 =RF(channel*3,channel)
        self.rf2 =RF(channel*3,channel)
        self.rf3 =RF(channel*3,channel)
    ...
    #    x1 =self.Translayer1(x1)
        ...
        att_out1 =self.upsample1(flusion1)+low_feature
        att_out2 = self.upsample2(flusion2)+low_feature
        att_out3 = self.upsample(flusion3)+low_feature
        ...
        prediction1 = F.interpolate(out1, scale_factor=4, mode='bilinear')
        prediction2 = F.interpolate(out2, scale_factor=4, mode='bilinear')
        prediction3 = F.interpolate(out3, scale_factor=4, mode='bilinear')
...
if __name__ == '__main__':
    ...
    prediction1, prediction2,prediction3,lateral_edge= model(input_tensor)
    print(prediction1.size(), prediction2.size(),prediction3.size(),lateral_edge.size())
    # net =BCA(64,64,64)
